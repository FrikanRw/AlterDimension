...
var wmsLayer = L.tileLayer.wms('http://alteram.dedicated.co.za:8091/geoserver/alteram//ows?', {Layers: 'alteram:c4ctickets', transparent: true, format:'image/png'}).addTo(map);
...
function Identify(e)
{
    ...
    var URL = 'http://alteram.dedicated.co.za:8091/geoserver/alteram/ows?SERVICE=WMS&VERSION=1.1.0&REQUEST=GetFeature&typeName=alteram:c4ctickets&QUERY_LAYERS=alteram:c4ctickets&BBOX='+BBOX+'&FEATURE_COUNT=1&HEIGHT='+HEIGHT+'&WIDTH='+WIDTH+'&INFO_FORMAT=text%2Fhtml&SRS=EPSG%3A4326&X='+X+'&Y='+Y;
...
function Filter() {
    ...
    var filtergeoJsonUrl = "http://alteram.dedicated.co.za:8091/geoserver/alteram/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=alteram:c4ctickets&CQL_Filter=lifecyclestatuscode" + statusFilterParam + '%20AND%20servicetermsserviceissuecategoryid'+ serviceFilterParam +'%20AND%20interactivechannel'+ interactiveFilterParam +"&outputFormat=application%2Fjson";
