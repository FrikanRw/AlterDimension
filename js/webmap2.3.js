...
var localJsonUrl = "http://alteram.dedicated.co.za:8091/geoserver/alteram/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=alteram:localmunicipalities_current&outputFormat=application%2Fjson";
//URL testbay
...
legend.onAdd = function (map) {
    var div = L.DomUtil.create('div', 'info legend'),
        grades = [0, 50, 150,500, 1000, 1500, 2500, 5000, 8000],
        labels = [],
        from, to;
